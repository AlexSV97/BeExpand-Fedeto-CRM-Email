...
export const MOCK_KNOWLEDGE_VAULT: KnowledgeVaultView = {
  articles: [
    { id: 'KB-001', title: 'BGP Route Flap Mitigation — Standard Operating Procedure', excerpt: 'Step-by-step SOP for identifying and mitigating BGP route flaps across all managed peers.', category: 'SOPs', tags: ['bgp', 'routing', 'flap', 'mitigation'], updatedAt: '2026-06-15T10:30:00Z' },
    { id: 'KB-002', title: 'DDoS Mitigation Playbook — Layer 3/4 Attacks', excerpt: 'Comprehensive playbook for detecting, classifying, and mitigating volumetric DDoS attacks.', category: 'Playbooks', tags: ['ddos', 'mitigation', 'layer3', 'layer4'], updatedAt: '2026-06-14T08:00:00Z' },
    { id: 'KB-003', title: 'Known Issue: MX-480 Line Card LC-4XGE-XFP Hard Lockup', excerpt: 'Under sustained 90%+ throughput, LC-4XGE-XFP line cards may enter a hard lockup state.', category: 'Known Issues', tags: ['mx-480', 'line-card', 'lockup', 'hardware'], updatedAt: '2026-06-13T14:15:00Z' },
    { id: 'KB-004', title: 'Release Notes — v3.2.0 Security Policy Engine', excerpt: 'New security policy engine introduces zone-based firewalling and application-layer inspection.', category: 'Release Notes', tags: ['release', 'security', 'policy', 'engine'], updatedAt: '2026-06-12T16:45:00Z' },
    { id: 'KB-005', title: 'SOP: SSL/TLS Certificate Renewal via ACME Automation', excerpt: 'Automated certificate lifecycle management using ACME protocol.', category: 'SOPs', tags: ['ssl', 'tls', 'certificate', 'acme', 'renewal'], updatedAt: '2026-06-11T09:00:00Z' },
  ],
  categories: ['SOPs', 'Playbooks', 'Known Issues', 'Release Notes'],
  searchSuggestions: ['bgp', 'ddos', 'certificate', 'security', 'sla'],
}
...
export const MOCK_ARTICLES: MockArticle[] = [
  { id: 'KB-001', title: 'BGP Route Flap Mitigation — Standard Operating Procedure', excerpt: 'Step-by-step SOP for identifying and mitigating BGP route flaps across all managed peers. Covers monitoring, confirmation, rollback, and post-mortem.', category: 'SOPs', tags: ['bgp', 'routing', 'flap', 'mitigation'], updatedAt: '2026-06-15T10:30:00Z', relevance: 98 },
  { id: 'KB-002', title: 'DDoS Mitigation Playbook — Layer 3/4 Attacks', excerpt: 'Comprehensive playbook for detecting, classifying, and mitigating volumetric DDoS attacks targeting customer-facing infrastructure.', category: 'Playbooks', tags: ['ddos', 'mitigation', 'layer3', 'layer4'], updatedAt: '2026-06-14T08:00:00Z', relevance: 95 },
  { id: 'KB-003', title: 'Known Issue: MX-480 Line Card LC-4XGE-XFP Hard Lockup', excerpt: 'Under sustained 90%+ throughput, LC-4XGE-XFP line cards may enter a hard lockup state requiring manual OIR. Affected firmware versions: 18.2R1-18.4R2.', category: 'Known Issues', tags: ['mx-480', 'line-card', 'lockup', 'hardware'], updatedAt: '2026-06-13T14:15:00Z', relevance: 91 },
  { id: 'KB-004', title: 'Release Notes — v3.2.0 Security Policy Engine', excerpt: 'New security policy engine introduces zone-based firewalling, application-layer inspection, and TLS 1.3 termination. Backward-compatible config migration.', category: 'Release Notes', tags: ['release', 'security', 'policy', 'engine'], updatedAt: '2026-06-12T16:45:00Z', relevance: 88 },
  { id: 'KB-005', title: 'SOP: SSL/TLS Certificate Renewal via ACME Automation', excerpt: 'Automated certificate lifecycle management using ACME protocol with Let\'s Encrypt and Sectigo. Covers validation, renewal, and revocation workflows.', category: 'SOPs', tags: ['ssl', 'tls', 'certificate', 'acme', 'renewal'], updatedAt: '2026-06-11T09:00:00Z', relevance: 85 },
  { id: 'KB-006', title: 'Incident Response Playbook — Ransomware Detection', excerpt: 'Detection, containment, eradication, and recovery steps for ransomware incidents affecting customer environments. Includes IOC indicators and C2 blocklists.', category: 'Playbooks', tags: ['ransomware', 'incident', 'response', 'security'], updatedAt: '2026-06-10T11:30:00Z', relevance: 92 },
  { id: 'KB-007', title: 'Known Issue: SNMP BulkWalk Timeout on Large OID Trees', excerpt: 'SNMP bulkwalk operations against OID trees exceeding 10,000 nodes may time out after 30s. Workaround: use walk with max-repetitions 25 or split queries.', category: 'Known Issues', tags: ['snmp', 'bulkwalk', 'timeout', 'monitoring'], updatedAt: '2026-06-09T13:20:00Z', relevance: 78 },
  { id: 'KB-008', title: 'Release Notes — v2.1.0 Log Aggregation Pipeline', excerpt: 'New log aggregation pipeline with Elasticsearch 8.x backend, improved indexing performance, and support for structured syslog over TCP/TLS.', category: 'Release Notes', tags: ['release', 'logging', 'elasticsearch', 'pipeline'], updatedAt: '2026-06-08T10:00:00Z', relevance: 82 },
]
