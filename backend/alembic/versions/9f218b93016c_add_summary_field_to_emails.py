"""add summary field to emails

Revision ID: 9f218b93016c
Revises: 6cf8e53ba70a
Create Date: 2026-05-15 15:48:09.865454
...
def upgrade() -> None:
    ...
    sa.Column('email_host', sa.String(length=255), nullable=False),
    sa.Column('email_port', sa.Integer(), nullable=False),
    sa.Column('email_user', sa.String(length=255), nullable=False),
    sa.Column('email_pass', sa.String(length=500), nullable=False),
